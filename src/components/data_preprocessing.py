...
class DataTransformationConfig:
    ...
    """
    ratings_object_file_path: str = os.path.join(
        'artifacts', 'ratings.pkl')
    pivot_table_object_file_path: str = os.path.join(
...
class DataTransformation:
    ...
    def initiate_data_transformation(self, books_data_path, users_data_path, ratings_data_path):
        """
        ...
        try:
            ...
            logging.info('Grouping the merged data by book title and counting the ratings')
            ...
            logging.info('Merging the rating counts with the merged ratings and books data')
            ...
            logging.info('Filtering the final ratings data to include books with at least 50 ratings')
